...
<div className="login page flex flex-col mt-[7%] justify-center align-middle items-center font-semibold  text-[#090918] rounded-md py-10 px-10 border-[1px] backdrop-blur-sm bg-white/30 border-[#c6bebe] w-[400px] "> 
    ...
    <form action="" className=' flex flex-col gap-[12px] items-center  text-[16px] text-[#f1f4f1]  '>
      ...
      <button className=' text-[24px] text-[#090918] mt-4' type="submit">Register</button>
      </div>
    </form>
