   ...
   <div className="">     <BookingForm/></div>
    ...
    return (
     ...
     <h1 className=' font-black  '>  {place.title}</h1>
       <h2 className=" font-normal flex underline ">🗺{ " " +place.address}</h2>
     </div>
     <div title=' Mobile no'  className="flex gap-2 cursor-pointer px-[30px] bg-gray-400 rounded-xl w-fit p-3 justify-center align-middle items-center">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6  hover:rotate-90">
